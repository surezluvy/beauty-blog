...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background-color: black">
            <div class="container">
                <a class="navbar-brand" href="index.php">Beauty Skin</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Article</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php#video">Video</a></li>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                ...
                <div class="row">
                    <?php
                        $data = read("artikel", "ORDER BY id_artikel ASC");
                        while($data2 = mysqli_fetch_array($data)){
                    ?>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <!-- Portfolio item 1-->
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $data2['id_artikel'] ?>">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" style="height: 250px; width: 500px" src="assets/img/artikel/<?php echo $data2['foto_artikel'] ?>" alt="..." />
                            </a>
