    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">Healthy skin is a reflection of overall wellness.</div>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                ...
                <div class="row">
                    <?php
                        $data = read("artikel", "ORDER BY id_artikel ASC LIMIT 0, 6");
                    ...
                    <?php } ?>
                    <div class="text-center"><br><a href="article.php#portfolio" class="btn btn-primary btn-xl text-uppercase">More article</a></div>
                </div>
            </div>
        </section>
        <!-- Portfolio Grid-->
        <section class="page-section bg-light" id="video">
            <div class="container">
                ...
                <div class="row">
                    <?php
                        $data = read("video", "ORDER BY id_video ASC LIMIT 0, 4");
                        while($data2 = mysqli_fetch_array($data)){
                    ?>
                    ...
                    <?php } ?>
                    <div class="text-center"><br><a href="video.php#video" class="btn btn-primary btn-xl text-uppercase">More video</a></div>
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    ...
                    <div class="d-none" id="submitSuccessMessage">
                        <div class="text-center text-white mb-3">
                            <div class="fw-bolder">Thank's for contact us!</div>
                        </div>
                    </div>
